...
# ═══════════════════════════════════════════════════════════════════════════════
# CHART 1 — Stacked area: generation mix (all fuel types)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# CHART 2 — Grouped mix & carbon intensity
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# ROW — Total output line  |  CO₂ contribution bar
# ═══════════════════════════════════════════════════════════════════════════════
col_a, col_b = st.columns(2)

with col_a:
    section("Output", "Total Output Over Time")
    fig_total = go.Figure()
    ...
    apply_layout(fig_total, yaxis_title="MW")
...
# ═══════════════════════════════════════════════════════════════════════════════
# CHART — Wind output vs wind speed (full width)
# ═══════════════════════════════════════════════════════════════════════════════
section("Weather Correlation", "Wind Output vs Wind Speed (100m)")
...
fig_wind.add_trace(go.Scatter(
    ...
    line=dict(color="#4b5680", width=1.5, dash="dot"),
))
apply_layout(fig_wind,
    yaxis=dict(**PLOT_LAYOUT["yaxis"], title="MW"),
    yaxis2=dict(
        title=dict(text="m/s"),
        overlaying="y", side="right",
    ...
    legend=dict(**PLOT_LAYOUT["legend"], orientation="h", y=-0.15),
)
